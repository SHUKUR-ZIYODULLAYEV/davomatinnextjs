...
function Login() {
  ...
  return (
    <div style={{backgroundImage: 'url("images/bg.jpg")',  backgroundSize: 'cover', backgroundPosition: 'center' }}
        className="fixed top-0 left-0 w-screen h-screen bg-center bg-cover flex justify-center items-center overflow-hidden"
    >
                ...
                <form onClick={(e) => e.preventDefault()}>
                  <div>
                    ...
                    <div className="relative">
                      <input
                            ...
                            className="block w-full pl-[25px] py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border rounded-md focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                        />
                  ...
                  <div className="mt-6">
                    ...
                    <div className="relative">
                      <input
                            ...
                            id="password"
                            placeholder="Parol"
                            className="block w-full px-[25px] py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border rounded-md focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                        />
                      <div className="absolute top-0 h-full flex items-center ml-[5px]">
                  ...
                  <div className="my-6">
                    ...
                    >
                      Kirish
                      <VscLoading
                        className="animate-spin ml-[10px]"
                      />
                    </button>
                  </div>
                </form>
